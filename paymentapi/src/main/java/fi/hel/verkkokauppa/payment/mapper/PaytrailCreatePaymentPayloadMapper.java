 ...
 */
@Component
public class PaytrailCreatePaymentPayloadMapper extends AbstractModelMapper<CreatePaymentPayload, PaytrailPaymentCreateMitChargeRequest.CreateMitChargePayload> {

    @Autowired
    public PaytrailCreatePaymentPayloadMapper(ObjectMapper mapper) {
        super(mapper, CreatePaymentPayload::new, PaytrailPaymentCreateMitChargeRequest.CreateMitChargePayload::new);
    }
}
