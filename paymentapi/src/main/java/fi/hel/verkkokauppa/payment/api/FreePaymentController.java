...
import fi.hel.verkkokauppa.payment.service.FreePaymentService;
...
public class FreePaymentController {
    ...
    @Autowired
    private FreePaymentService service;

	@Autowired
	private OnlinePaymentService onlinePaymentService;

	@PostMapping(value = "/payment/free/createFromOrder", produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping("/payment/free/check-return-url")
