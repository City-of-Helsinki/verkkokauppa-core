...
@Component
public class PaytrailCreateTokenPaymentPayloadConverter implements IPaytrailPayloadConverter<CreateMitChargePayload, OrderWrapper> {

    @Autowired
    private Environment env;

    @Override
    public CreateMitChargePayload convertToPayload(PaytrailPaymentContext context, OrderWrapper orderWrapper, String stamp) {
    ...
    public CreateMitChargePayload convertToPayload(PaytrailPaymentContext context, OrderWrapper orderWrapper, String stamp, String token){
        // call original convertToPayload since it needs to be implemented
        CreateMitChargePayload payload = convertToPayload(context, orderWrapper, stamp);
        // add token
