...
public class AccountingSlipServiceTests extends DummyData {
    ...
    public void testAccountingsAreSummedPerPostingForEachCompanyCode() {
        ...
        OrderItemAccounting orderItemAccounting1 = new OrderItemAccounting("1", "1", "20", "10", companyCode1, "account", "24", "yes",
                "profitCenter", "project 1", "Area A");
        OrderItemAccounting orderItemAccounting2 = new OrderItemAccounting("2", "2", "10", "5", companyCode1, "account", "24", "yes",
                "profitCenter", "project 2", "Area B");
        OrderItemAccounting orderItemAccounting3 = new OrderItemAccounting("3", "2", "10", "5", companyCode1, "account", "24", "yes",
                "profitCenter", "project 2", "Area B");

        String companyCode2 = "5678";
        OrderItemAccounting orderItemAccounting4 = new OrderItemAccounting("2", "2", "10", "5", companyCode2, "account", "24", "yes",
                "profitCenter", "project 2", "Area B");
        OrderItemAccounting orderItemAccounting5 = new OrderItemAccounting("3", "2", "10", "5", companyCode2, "account", "24", "yes",
                "profitCenter", "project 2", "Area B");
        ...
        expectedListForCompanyCode1.add(new OrderItemAccountingDto("2", "2", "20", "10", companyCode1, "account", "24", "yes", "profitCenter", "project 2", "Area B"));
        ...
        expectedListForCompanyCode2.add(new OrderItemAccountingDto("2", "2", "20", "10", companyCode2, "account", "24", "yes", "profitCenter", "project 2", "Area B"));
