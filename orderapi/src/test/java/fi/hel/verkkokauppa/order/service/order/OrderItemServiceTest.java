...
class OrderItemServiceTest {
    ...
    void addItem() {
        ...
        String orderItem1 = orderItemService.addItem(orderId, "productId", "productName", 1, "unit", "rowPriceNet", "rowPriceVat", "rowPriceTotal", "vatPercentage", "priceNet", "priceVat", "priceGross","",0L,0,null,null);
        String orderItem2 = orderItemService.addItem(orderId, "productId", "productName", 1, "unit", "rowPriceNet", "rowPriceVat", "rowPriceTotal", "vatPercentage", "priceNet", "priceVat", "priceGross","",0L,0,null,null);
