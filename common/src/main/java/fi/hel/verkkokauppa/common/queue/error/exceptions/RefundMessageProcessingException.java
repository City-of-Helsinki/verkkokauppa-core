...
@Slf4j
@Data
public class RefundMessageProcessingException extends RuntimeException {
    private RefundMessage refundMessage;

    public RefundMessageProcessingException(String message, RefundMessage refundMessage) {
        super(message);
